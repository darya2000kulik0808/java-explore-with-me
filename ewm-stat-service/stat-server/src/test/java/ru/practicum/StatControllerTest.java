...
class StatControllerTest {
    ...
    void shouldAdd() throws Exception {
        ...
        doNothing().when(service).postStat(hitDto);
    ...
    void shouldGetEmptyStat() throws Exception {
        //EmptyList
        when(service.getStats(start, end, URIS_DEFAULT, UNIQUE_DEFAULT))
    ...
    void shouldGetStat() throws Exception {
        //SingleList
        ViewStatsDto viewStatsDto = viewStatsDtoBuilder.hits(1L).build();
        when(service.getStats(start, end, URIS_DEFAULT, UNIQUE_DEFAULT))
